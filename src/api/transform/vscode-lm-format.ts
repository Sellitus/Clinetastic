...
function asObjectSafe(value: any): object {
	...
	try {
		...
		console.warn("Clinetastic <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
...
export async function convertToAnthropicMessage(
	...
	if (anthropicRole !== "assistant") {
		throw new Error("Clinetastic <Language Model API>: Only assistant messages are supported.")
	}
