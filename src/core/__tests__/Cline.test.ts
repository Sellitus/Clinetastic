...
describe("Cline", () => {
	...
	beforeEach(() => {
		...
		cline = new Cline(mockProvider, mockApiConfig, undefined, false, undefined, "test task")
	})
	...
	describe("constructor", () => {
		it("should respect provided settings", () => {
			expect(cline.customInstructions).toBe(undefined)
		...
		it("should use provided fuzzy match threshold", () => {
			...
			const clineWithThreshold = new Cline(
				mockProvider,
				mockApiConfig,
				"custom instructions",
				true,
			...
			expect(clineWithThreshold.diffEnabled).toBe(true)
			expect(clineWithThreshold.diffStrategy).toBeDefined()
		...
		it("should require either task or historyItem", () => {
			expect(() => {
				new Cline(mockProvider, mockApiConfig, undefined, false, undefined, undefined)
	...
	describe("getEnvironmentDetails", () => {
		...
		it("should include timezone information in environment details", async () => {
			...
			expect(details).toContain("UTC-7:00")
